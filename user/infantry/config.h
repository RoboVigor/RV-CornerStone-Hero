...
// k0,k1,k2,k3,k4,k5
#define SECOND_MACLAURIN_COEFFICIENT                                                                                                                           \
    {0.6641993412640775, 0.006444284468539646, 0.0001423857226262331, 0.017644430204543864, 0.1650143850678086, 0.00003096721772539512}
...
#endif
#define trans_matrix                                                                                                                                           \
    {f_cos(angle_y) * f_cos(angle_z),                                                                                                                          \
     f_cos(angle_x) * f_sin(angle_z) + f_cos(angle_z) * f_sin(angle_x) * f_sin(angle_y),                                                                       \
     f_sin(angle_x) * f_sin(angle_z) - f_cos(angle_x) * f_cos(angle_z) * f_sin(angle_y),                                                                       \
     -f_cos(angle_y) * f_sin(angle_z),                                                                                                                         \
     f_cos(angle_x) * f_cos(angle_z) - f_sin(angle_x) * f_sin(angle_y) * f_sin(angle_z),                                                                       \
     f_cos(angle_z) * f_sin(angle_x) + f_cos(angle_x) * f_sin(angle_y) * f_sin(angle_z),                                                                       \
     f_sin(angle_y),                                                                                                                                           \
     -f_cos(angle_y) * f_sin(angle_x),                                                                                                                         \
     f_cos(angle_x) * f_cos(angle_y)}
